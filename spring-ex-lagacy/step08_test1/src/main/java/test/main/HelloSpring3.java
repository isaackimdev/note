...
import test.service.ScoreServiceImpl3;

@Component
public class HelloSpring3 {
	@Autowired
	ScoreServiceImpl3 scoreService;
	...
	private void search() {
		...
		if(vo != null) {
			...
			System.out.println("해당 학번 정보가 없습니다.");
		}
	...
	public static void main(String[] args) {
		...
		HelloSpring3 helloSpring = context.getBean("helloSpring", HelloSpring3.class);
		helloSpring.menu();
